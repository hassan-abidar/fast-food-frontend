...
export const EDIT_EVENTS_REQUEST = "EDIT_EVENT_REQUEST";
export const EDIT_EVENTS_SUCCESS = "EDIT_EVENT_SUCCESS";
export const EDIT_EVENTS_FAILURE = "EDIT_EVENT_FAILURE";
